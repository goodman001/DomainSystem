        ...
        <ul class="sub-menu">
            <li class="active">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="active"><a href="<?php echo U('Configure/general_mail');;?>">Mail</a></li>
...
<div class="row-fluid">
    <div class="span12">
        ...
        <ul class="breadcrumb">
			...
			<li><a href="#">Mail</a><i class="fa fa-angle-right" aria-hidden="true"></i></li>
        </ul>
...
<div class="row-fluid">
    <div class="span12">
<!--BEGIN TABS-->
	<h4><i class="fa fa-cog" aria-hidden="true"></i> Mail setting</h4>
	<label>PHP mail setting</label>
<!--END TABS-->
    </div>
</div>
<!-- END PAGE CONTENT-->
