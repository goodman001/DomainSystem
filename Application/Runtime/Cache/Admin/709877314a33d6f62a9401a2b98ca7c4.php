...
<div class="row-fluid">
    <div class="span12">
        ...
        <ul class="breadcrumb">
			...
			<li><a href="#">Credit</a><i class="fa fa-angle-right" aria-hidden="true"></i></li>
        </ul>
...
<div class="row-fluid">
    <div class="span12">
<!--BEGIN TABS-->
	<h4><i class="fa fa-cog" aria-hidden="true"></i> Credit</h4>
	<label>Refill credit by users</label>
	<button type="button" class="btn red">Enable</button>
	<button type="button" class="btn">Disable</button>
	<label>Max/Min Deposit</label>
	<input type="text" value="0.0" name="min deposit" pattern="^[0-9]+([\.,]{0,1}[0-9]*)$" maxlength="15" minlength="1"   class="m-wrap span8">
	<input type="text" value="0.0" name="max deposit" pattern="^[0-9]+([\.,]{0,1}[0-9]*)$" maxlength="15" minlength="1"   class="m-wrap span8">
	<label>Max balance</label>
	<input type="text" value="0.0" name="min deposit" pattern="^[0-9]+([\.,]{0,1}[0-9]*)$" maxlength="15" minlength="1"   class="m-wrap span8">
	<label>Only can use on active invoice</label>
	<button type="button" class="btn red">Enable</button>
	<button type="button" class="btn">Disable</button>
<!--END TABS-->
    </div>
