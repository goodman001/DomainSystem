...
<div class="tab-pane" id="tab_1_2">
	<div style="height: auto;" id="accordion1-1" class="accordion collapse">
        <div class="span12">
            <h4><i class="fa fa-cog" aria-hidden="true"></i> Transaction Manager</h4>
                <form role="form" action="<?php echo U('Transaction/transupdate?transid='.$transid.'');;?>" method="post">  
                    ...
                    <input name="invoiceid" type="text" id="clientname" placeholder="invoiceid" value="<?php echo ($trans["invoiceID"]); ?>" class="m-wrap span8" required/>
					...
					<input type="text" value="<?php echo ($trans["settleamount"]); ?>" name="amount" pattern="^[0-9]+([\.,]{0,1}[0-9]*)$" maxlength="15" minlength="1"   class="m-wrap span8" required>
