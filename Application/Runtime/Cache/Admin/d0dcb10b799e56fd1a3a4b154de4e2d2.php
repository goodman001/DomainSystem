...
<div class="row-fluid">
    <div class="span12">
        ...
        <ul class="breadcrumb">
			...
			<li>
				<a href="<?php echo U('Configure/taxrules');;?>">Tax Rules</a>
			</li>
        </ul>
...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="#tab_1_0" data-toggle="tab">Tax on/off</a></li>
	<li><a href="#tab_1_1" data-toggle="tab">List Active Tax Rules</a></li>
	<li><a href="#tab_1_2" data-toggle="tab">Add new currency</a></li>
</ul>
<div class="tab-content">

<!--end tab-pane-->
<div class="tab-pane row-fluid active" id="tab_1_0">
    <div class="span12">
    ...
    <table class="table table-striped table-hover">
	   ...
	   <tbody>
		  <tr>
			...
			<td>USA</td>
			<td>0.25</td>
			<td><a class="btn red easy-pie-chart-reload" href="">UPDATE</a><a class="btn yellow easy-pie-chart-reload" href="">DELETE</a></td>
		  </tr>
		  <tr>
			<td>2</td>
			<td>1</td>
...
<div class="tab-pane" id="tab_1_2">
	<div style="height: auto;" id="accordion1-1" class="accordion collapse">
        <div class="span12">
            <h4><i class="fa fa-cog" aria-hidden="true"></i> Add new Tax Rule</h4>
            <div class="span4">
                <form role="form" action="" method="post">  
					...
					<label class="control-label">Tax rule name</label>
                    <input name="name" type="text" placeholder="tax rule name" value="" class="m-wrap span8" required/>
					<label class="control-label">Country</label>
                    <input name="country" type="text" placeholder="country" class="m-wrap span8" required/>
                    <label class="control-label">Tax rating</label>
                    <input name="formate" type="text" placeholder="Tax rating" class="m-wrap span8" required/>
