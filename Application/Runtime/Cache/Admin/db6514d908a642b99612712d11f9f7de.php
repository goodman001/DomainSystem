        ...
        <ul class="sub-menu">
            <li class="active">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="active"><a href="<?php echo U('Configure/general_language');;?>">Language</a></li>
...
<div class="row-fluid">
    <div class="span12">
        ...
        <ul class="breadcrumb">
			...
			<li><a href="#">Language Setting</a><i class="fa fa-angle-right" aria-hidden="true"></i></li>
        </ul>
...
<div class="row-fluid">
    <div class="span12">
<!--BEGIN TABS-->
	<h4><i class="fa fa-cog" aria-hidden="true"></i> Language Setting</h4>
	<form role="form" action="<?php echo U('Configure/languagesetting');;?>" method="post">  
		<label>Language Setting</label>
		<select class="m-wrap span8" name="language" required>
			<option value= "pending">EN</option>
		</select>
