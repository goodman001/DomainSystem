...
<ul class="nav nav-tabs">
    ...
    <li><a href="#tab_1_2" data-toggle="tab">Deposit credit</a></li>
...
<div class="tab-pane profile-classic row-fluid" id="tab_1_2">
    ...
    <form role="form" action="<?php echo U('Client/updateprofile');;?>" method="post">  
            ...
            <input type="number" value="" name="postcode" id="postcode" placeholder="0.0$<?php echo ($type); ?>"  class="m-wrap span8" required> 
