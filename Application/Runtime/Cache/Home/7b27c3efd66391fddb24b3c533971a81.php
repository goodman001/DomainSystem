...
<li class="start active ">
    ...
    <a href="index.html">
        ...
        <span class="title">图表--Dashboard</span>
        ...
        <div class="portlet solid bordered light-grey">
            ...
            <div class="portlet-body">
                ...
                <div id="site_statistics_loading">
                    ...
                    <img src="/DomainSystem/Public/metronic/media/image/loading.gif" alt="loading"/>
...
<div class="row-fluid">
    ...
    <div class="span6 user-info">
        ...
        <img alt="" src="/DomainSystem/Public/metronic/media/image/avatar.png"/>
...
<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
    ...
    <ul class="chats">
        ...
        <li class="in">
            ...
            <img class="avatar" alt="" src="/DomainSystem/Public/metronic/media/image/avatar1.jpg"/>
        ...
        <li class="out">
            ...
            <img class="avatar" alt="" src="/DomainSystem/Public/metronic/media/image/avatar2.jpg"/>
        ...
        <li class="out">
            ...
            <img class="avatar" alt="" src="/DomainSystem/Public/metronic/media/image/avatar3.jpg"/>
